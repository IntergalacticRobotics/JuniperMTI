...
@Autonomous
public class Left1_5Timestamps extends LinearOpMode {
    ...
    private ElapsedTime cycleTimerContinued;
...
/** Robot Tuning Variables: **//*
    ...
    public void runOpMode() {
        ...
        cycleTimerContinued = new ElapsedTime();
...
/* Start Loop *//*
        ...
        TrajectorySequence Auto1plus3 = drive.trajectorySequenceBuilder(new Pose2d(startX, startY, startHeading))
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    ...
                    telemetry.addData("Preload placed at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds, total time: " + cycleTimerContinued.time(TimeUnit.SECONDS) + " seconds.");
                    timer.reset();
                })
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.0, () -> {
                    telemetry.addData("Stopped moving forward at : ", cycleTimer.time(TimeUnit.SECONDS) + " seconds, total time: " + cycleTimerContinued.time(TimeUnit.SECONDS) + " seconds." );
                    timer.reset();
                })
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    linearSLides.setGripperPosition(.75);
                    telemetry.addData("1st cone picked up at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds, total time: " + cycleTimerContinued.time(TimeUnit.SECONDS) + " seconds.");
                    timer.reset();
                })
                .waitSeconds(.25)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    linearSLides.setGripperPosition(1.0);
                    telemetry.addData("1st cone placed at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds, total time: " + cycleTimerContinued.time(TimeUnit.SECONDS) + " seconds." );
                    timer.reset();
                })
                .waitSeconds(0.05)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    linearSLides.setGripperPosition(.75);
                    telemetry.addData("2nd cone picked up at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds, total time: " + cycleTimerContinued.time(TimeUnit.SECONDS) + " seconds." );
                    timer.reset();
                })
                .waitSeconds(.25)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    linearSLides.setGripperPosition(1.0);
                    telemetry.addData("2nd cone placed at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds, total time: " + cycleTimerContinued.time(TimeUnit.SECONDS) + " seconds." );
                    timer.reset();
                })
                .waitSeconds(0.05)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    linearSLides.setGripperPosition(.75);
                    telemetry.addData("3rd cone picked up at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds, total time: " + cycleTimerContinued.time(TimeUnit.SECONDS) + " seconds." );
                    timer.reset();
                })
                .waitSeconds(.25)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    linearSLides.setGripperPosition(1.0);
                    telemetry.addData("3rd cone placed at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds, total time: " + cycleTimerContinued.time(TimeUnit.SECONDS) + " seconds." );
                    timer.reset();
                })
                .waitSeconds(0.05)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.0, () -> {
                    linearSLides.setGripperPosition(.75);
                    telemetry.addData("4th cone picked up at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds, total time: " + cycleTimerContinued.time(TimeUnit.SECONDS) + " seconds." );
                    timer.reset();
                })
                .waitSeconds(.25)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    linearSLides.setGripperPosition(1.0);
                    telemetry.addData("4th cone placed at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds, total time: " + cycleTimerContinued.time(TimeUnit.SECONDS) + " seconds." );
                    timer.reset();
                })
                .waitSeconds(0.05)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    ...
                    telemetry.addData("Parked at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds, total time: " + cycleTimerContinued.time(TimeUnit.SECONDS) + " seconds." );
                    timer.reset();
                })
                .waitSeconds(3)
                .build();
